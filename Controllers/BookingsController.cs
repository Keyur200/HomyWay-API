...
namespace HomyWayAPI.Controllers
{
    ...
    public class BookingsController : ControllerBase
    {
        ...
        {
            var booking = await _context.Bookings.Include(b => b.Property).Include(b => b.Property.ImagesNavigation).Where(b => b.Property.HostId == hostId).OrderByDescending(b => b.Checkkin).ToListAsync();
            return Ok(booking);
        }
